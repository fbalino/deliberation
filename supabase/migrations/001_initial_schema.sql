...
-- RLS + permissive policies (no auth, single-user app)
alter table presets enable row level security;
create policy "allow_all" on presets for all using (true) with check (true);
...
create policy "allow_all" on session_files for all using (true) with check (true);

alter table panelists enable row level security;
create policy "allow_all" on panelists for all using (true) with check (true);
...
create policy "allow_all" on resolutions for all using (true) with check (true);

alter table cost_log enable row level security;
create policy "allow_all" on cost_log for all using (true) with check (true);
